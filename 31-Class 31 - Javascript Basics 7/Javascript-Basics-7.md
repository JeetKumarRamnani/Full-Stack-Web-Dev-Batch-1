...
2. **Ways To Implement Control Structures**
3. **What Is Condition**
4. **What Are Conditional Statments**
5. **What Are Comparision Expressions**
6. **What is if statement**
7. **What is Else Statement**
8. **What is if/else statements**
